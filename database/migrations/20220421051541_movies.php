...
class Movies extends Migrator
{
    ...
    public function change()
    {
        ...
        $table->addColumn('title', 'string', ['limit' => 255, 'comment' => '名称'])
            ...
            ->addColumn('star_list', 'string', ['limit' => 255, 'default' => '', 'comment' => '主演列表'])
            ->addColumn('genre_list', 'string', ['limit' => 255, 'default' => '', 'comment' => '分类列表'])
            ->addColumn('series_list', 'string', ['limit' => 255, 'default' => '', 'comment' => '系列列表'])
            ->addColumn('publisher', 'string', ['limit' => 30, 'default' => '', 'comment' => '发行商'])
            ->addColumn('producer', 'string', ['limit' => 30, 'default' => '', 'comment' => '制片商'])
            ->addColumn('director', 'string', ['limit' => 30, 'default' => '', 'comment' => '导演'])
            ->addColumn('similar', 'string', ['limit' => 255, 'default' => '', 'comment' => '同类型'])
            ...
            ->addColumn('region', 'integer', ['limit' => 1, 'default' => 0, 'comment' => '地区，「0默认，1欧美」'])
